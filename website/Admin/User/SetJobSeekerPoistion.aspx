<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="SetJobSeekerPoistion.aspx.cs" Inherits="Admin_User_SetUserPoistion" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

       <asp:HiddenField ID="hdfJobsekerId" runat="server" />
                            ...
                            <div class="col-lg-12">
                                <div class="element-wrapper">
                                    <h6 class="element-header">
                                        Set Job Seeker Position Order</h6>
                                    <div class="element-box">
                                        <div>
                                        <h5 class="form-header">
                                           Set Job Seeker Position Order</h5>

                                                <div class="form-buttons-w text-right">
                                            <a class="mr-2 mb-2 btn btn-primary btn-rounded" href="../Job/Upload_Job_List.aspx"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Go to JobSeeker List</a>
                                                     </div>
                                ...
                                <asp:Label ID="lblMSG" runat="server" Text="Label"></asp:Label>
                                            ...
                                            <legend><span>Job Seeker Position Order</span></legend>
                                       <label>Job Seeker Position Order</label>
