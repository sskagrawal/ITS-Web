    ...
    <div class="content-i">
        <div class="content-box">
            <div class="element-wrapper">
                <h6 class="element-header">User List</h6>
                        ...
                        <div class="col-md-12">
                            <div class="form-inline">
                                ...
                                <div class="col-md-2" style="padding-bottom: 10px">
                                    <label class="sr-only">
                                        User Type</label>
                                    <asp:DropDownList class="form-control mb-2 mr-sm-2 mb-sm-0" Width="100%" ID="drdUserType"
                                        runat="server">
                        ...
                        <div style="overflow: auto;">
                            ...
                            <asp:GridView ID="grdView" runat="server" AutoGenerateColumns="false" Font-Size="12px"
                                ...
                                <Columns>
                                  ...
                                  <asp:TemplateField HeaderText="StaffPhoto" HeaderStyle-BackColor="#047BF8" HeaderStyle-ForeColor="white">
                               <ItemTemplate>
                              ...
                              <%--  <asp:HiddenField ID="hdfCoPhotoImg" Value='<%#Eval("CoPhoto")%>' runat="server"></asp:HiddenField>--%>
                                   <asp:Literal ID="ltrPhoto" runat="server"></asp:Literal>
                                    ...
                                    <asp:TemplateField HeaderText="User Type" HeaderStyle-BackColor="#047BF8" HeaderStyle-ForeColor="white">
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle />
                                        <ItemTemplate>
                                            <%#Eval("UserTypeName")%>
                                    ...
                                    <asp:TemplateField HeaderText="Name" HeaderStyle-BackColor="#047BF8" HeaderStyle-ForeColor="white">
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle />
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Mobile No" HeaderStyle-BackColor="#047BF8" HeaderStyle-ForeColor="white">
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle />
                                        <ItemTemplate>
                                            <%#Eval("mobile_no")%>
