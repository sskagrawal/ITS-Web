...
public partial class BranchList : System.Web.UI.Page
{
    ...
    //    DataTable dt = DataAccess.GetData("select * from UserType where ID IN (4,2,3) "); //where CompanyID=" + hdfCompnyID.Value + "
    ...
    private void bindBranchList()
    {
        ...
        Query = "select * from [View_WebUserDetails] ";
        ...
        //{
        //    Query += whereConcatenator;
        //    Query += "UserTypeID ='" + drdUserType.SelectedValue + "'";
        //    whereConcatenator = " and ";
        //}
    ...
    protected void lnkBtnPrintExcel_Click(object sender, EventArgs e)
    {
        ...
        string attachment = "attachment; filename=Employee-companylist.xls";
