<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Add-ProductColor.aspx.cs" Inherits="Admin_Ecommerce_Add_ProductColor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="content-w">
        ...
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><span>Color Manager</span></li>
            ...
            <div class="content-panel-toggler"><i class="os-icon os-icon-grid-squares-22"></i><span>Sidebar</span></div><div class="content-i">
                <div class="content-box">
                    <div class="row">
                        <div class="col-sm-7">
                            <div class="element-wrapper">
                                <div class="element-box">
                                    ...
                                    <div id="formValidate"><h5 class="form-header">Add Colour</h5>
                        ...
                        <div class="form-group"><label for="">Colour Name</label> 
                            
                              <asp:TextBox ID="txtcol" runat="server" class="form-control" placeholder="Enter Color Name"  type="Category"></asp:TextBox>
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtcol"
                                             Display="None" ErrorMessage="Enter Colour" ForeColor="Red" SetFocusOnError="True"
                                            ValidationGroup="sv">*****</asp:RequiredFieldValidator>
                       ...
                       <div class="help-block form-text with-errors form-control-feedback"></div></div>
                        ...
                        <div class="form-buttons-w"><%--<button class="btn btn-primary" type="submit"> Save</button>--%>
                             <asp:Button ID="Button2" runat="server" OnClick="btnSubmit_Click"   ValidationGroup="sv" Text="Save"  class="btn btn-primary" />&nbsp&nbsp
                                    ...
                                    <h5 class="form-header">View Colour</h5>
                         ...
                         <asp:TemplateField >
                          ...
                          SrNo.
                              ...
                              <asp:Label ID="lblCategoryName" runat="server" Text='<%#Eval("CategoryName")%>'></asp:Label>
                               ...
                               <ItemTemplate>
                              <asp:Label ID="lbltName2" runat="server" Text='<%#Eval("Color_name")%>'></asp:Label>
                               </ItemTemplate>
                               </asp:TemplateField>
                               ...
                               <ItemTemplate>
                                ...
                                <%--<asp:HiddenField ID="hdf_ID"  runat="server" Value='<%#Eval("ColorMaster_id")%>' ></asp:HiddenField>--%>
