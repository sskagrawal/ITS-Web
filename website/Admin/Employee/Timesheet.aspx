<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Timesheet.aspx.cs" Inherits="Timesheet" %>
                                                ...
                                                <label class="col-sm-4 col-form-label" for="">
                                                    Entry Date</label><div class="col-sm-8">
                                                        <%--<input class="single-daterange form-control" placeholder="Date of birth" type="text"
                                                            value="04/12/1978">--%>
                                                        <asp:TextBox ID="TxtEntryDate" runat="server" class="form-control"  Cssclass="form-control"  placeholder="Enter Entry Date"></asp:TextBox>

                                                        <asp:CalendarExtender ID="CalendarExtender2" runat="server" ClientIDMode="Static" TargetControlID="TxtEntryDate" Format="dd/MM/yyyy">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label" for="">
                                                    Exit Date</label><div class="col-sm-8">
                                                        ...
                                                        <asp:TextBox ID="TxtExitDate" runat="server" Cssclass="form-control" placeholder="Exit Date"></asp:TextBox>


                                                        <asp:CalendarExtender ID="CalendarExtender1" runat="server" ClientIDMode="Static" TargetControlID="TxtExitDate" Format="dd/MM/yyyy">
                                            </asp:CalendarExtender>
