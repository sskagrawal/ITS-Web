<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="JobIndutry.aspx.cs" Inherits="Admin_JobType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <li class="breadcrumb-item"><a href="#">Add Industry</a></li>
  </ul>
  <!--------------------END - Breadcrumbs-------------------->
  <div class="content-i">
  ...
  <h6 class="element-header">Add Update Industry</h6>
  <div class="element-box">

  <h5 class="form-header">Add Update Industry</h5>
 ...
 <span aria-hidden="true"> ×</span>
  ...
  <label class="col-form-label col-sm-2" for="">Industry</label>
  <div class="col-sm-5">
      <asp:TextBox ID="txtIndustry" class="form-control" placeholder="Enter Industry" runat="server"></asp:TextBox>
         <asp:RequiredFieldValidator ID="rfvIndustry" runat="server" ControlToValidate="txtIndustry"
                                            ErrorMessage="Enter Industry Name" ForeColor="Red" SetFocusOnError="True" ValidationGroup="sv"
                                            Display="None">*</asp:RequiredFieldValidator>
                                             <asp:ValidatorCalloutExtender ID="VCEIndustry" 
                                            runat="server" Enabled="True" TargetControlID="rfvIndustry" WarningIconImageUrl="~/img/wrning.gif">
...
<asp:GridView ID="grdView" runat="server" AutoGenerateColumns="false" Font-Size="12px" EmptyDataText="Result Not Found" Width="100%" CssClass="table table-hover table-bordered table-condensed" PagerStyle-CssClass="odd gradeA" AlternatingRowStyle-CssClass="even gradeC"><%-- PagerSettings-Visible="false" AllowPaging="true" PageSize="10"--%>
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="S No." HeaderStyle-BackColor="#047BF8" HeaderStyle-ForeColor="white">
                                           ...
                                           <asp:TemplateField HeaderText="Industry" HeaderStyle-BackColor="#047BF8" HeaderStyle-ForeColor="white">
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle />
                                            <ItemTemplate>
                                             <%#Eval("Industry")%>
