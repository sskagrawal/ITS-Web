<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="AddQualification.aspx.cs" Inherits="Admin_JobType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <li class="breadcrumb-item"><a href="#">Add Qualification</a></li>
  </ul>
  <!--------------------END - Breadcrumbs-------------------->
  <div class="content-i">
  ...
  <h6 class="element-header">Add Update Qualification</h6>
  <div class="element-box">

  <h5 class="form-header">Add Update Qualification</h5>
 ...
 <span aria-hidden="true"> ×</span>
  ...
  <label class="col-form-label col-sm-2" for="">Qualification</label>
  <div class="col-sm-5">
      <asp:TextBox ID="txtQuali" class="form-control" placeholder="Enter Qualification" runat="server"></asp:TextBox>
         <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtQuali"
                                            ErrorMessage="Please Enter Qualification" ForeColor="Red" SetFocusOnError="True" ValidationGroup="sv"
