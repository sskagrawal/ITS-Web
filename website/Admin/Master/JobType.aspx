<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="JobType.aspx.cs" Inherits="Admin_OrganizationType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <li class="breadcrumb-item"><a href="#">Add Job Type</a></li>
  </ul>
  <!--------------------END - Breadcrumbs-------------------->
  <div class="content-i">
  ...
  <h6 class="element-header">Add Update Job Type</h6>
  <div class="element-box">

  <h5 class="form-header">Add Update Job Type</h5>
 ...
 <span aria-hidden="true"> ×</span>
  ...
  <div class="col-sm-5">
      <asp:TextBox ID="txtJobType" class="form-control" placeholder="Job Type" runat="server"></asp:TextBox>
         <asp:RequiredFieldValidator ID="rfvJobType" runat="server" ControlToValidate="txtJobType"
                                            ErrorMessage="Enter Job Type" ForeColor="Red" SetFocusOnError="True" ValidationGroup="sv"
                                            Display="None">*</asp:RequiredFieldValidator>
                                             <asp:ValidatorCalloutExtender ID="VCE_Jobtype" 
...
<asp:GridView ID="grdView" runat="server" AutoGenerateColumns="false" Font-Size="12px" EmptyDataText="Result Not Found" Width="100%" CssClass="table table-hover table-bordered table-condensed" PagerStyle-CssClass="odd gradeA" AlternatingRowStyle-CssClass="even gradeC" PagerSettings-Visible="false" AllowPaging="true" PageSize="10">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="S No." HeaderStyle-BackColor="#047BF8" HeaderStyle-ForeColor="white">
                                           ...
                                           <asp:TemplateField HeaderText="Job Type" HeaderStyle-BackColor="#047BF8" HeaderStyle-ForeColor="white">
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle />
                                            <ItemTemplate>
                                             <%#Eval("jobType")%>
