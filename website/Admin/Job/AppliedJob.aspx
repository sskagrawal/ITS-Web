<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="AppliedJob.aspx.cs" Inherits="Admin_Job_AppliedJob" %>
        ...
        <div class="content-box">
            <div class="element-wrapper">
                <h6 class="element-header">
                    User's Applied Job List</h6>
                <div class="element-box">
                    <h5 class="form-header">
                        User's Applied Job List</h5>
                    ...
                    <div class="row" style="border:1px solid grey;padding:20px;border-radius:20px;">
                        <%-- <span class="border border-info">--%>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <asp:DropDownList class="form-control mb-2 mr-sm-2 mb-sm-0" Width="100%" ID="drdSearch"
                                        ...
                                        <asp:ListItem  Value="MobileNo">Mobile</asp:ListItem>                                        
                                         <asp:ListItem  Value="job_Title">Apply for</asp:ListItem>
                         ...
                         <div class="col-md-2">
                                    <label class="sr-only">
                                        Job Post Date</label>
                                    <asp:TextBox ID="txtJobPostdate" class="form-control mb-2 mr-sm-2 mb-sm-0" placeholder="Job Post Date"
                                        runat="server"></asp:TextBox>
                                    <asp:CalendarExtender ID="calfromdate" runat="server" ClientIDMode="Static" TargetControlID="txtJobPostdate"
                        ...
                        <asp:GridView ID="grdView" runat="server" AutoGenerateColumns="false" Font-Size="12px"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="S.No.">
                                 ...
                                 <asp:TemplateField HeaderText="Applyed For">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle />
                                    <ItemTemplate>
                                         <%#Eval("job_Title")%>
                               ...
                               <asp:TemplateField HeaderText="Company Name">
                                    ...
                                    <ItemStyle />
                                    <ItemTemplate>
                                          <asp:Label ID="lblJobDet" runat="server" Text='<%#GetCompName(Eval("UserID"))%>'></asp:Label>
                                        
                                        
                                    </ItemTemplate>
                                </asp:TemplateField>

                                <asp:TemplateField HeaderText="Job Post Date">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle />
                                    <ItemTemplate>
                                    ...
                                    <ItemTemplate>
                                        <asp:HiddenField ID="hdfApplyJobID" runat="server" Value='<%#Eval("ID")%>' />
