<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Upload_job - Copy.aspx.cs" Inherits="Admin_Career" %>
...
<asp:HiddenField ID="hdfUserID" runat="server" />
 ...
 <%-- <div class="form-desc">Discharge best employed your phase each the of shine. Be met even reason consider logbook redesigns. Never a turned interfaces among asking</div>--%>
        ...
        <div class="form-group row"><label class="col-form-label col-sm-4" for="">Select Company</label>
  <div class="col-sm-8">
      <asp:DropDownList ID="drdCom" CssClass="form-control" runat="server">
      </asp:DropDownList>
      <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="drdJobTYpe"
                                        ErrorMessage="Please Select Company" ForeColor="Red" SetFocusOnError="True" ValidationGroup="svv"
 ...
 <div class="col-md-12">
  ...
  <div class="col-sm-8">
      <asp:DropDownList ID="drdExpri" CssClass="form-control" runat="server"></asp:DropDownList>
