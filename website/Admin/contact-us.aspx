...
<%@ Page Title="best web design company in gwalior, bhind, murena, dabra, lahar, porsa, bammore, dholpur, agra, datia, jhansi, madhya pradesh, india." MetaDescription="best web design company in gwalior, bhind, murena, dabra, lahar, porsa, bammore, dholpur, agra, datia, jhansi, madhya pradesh, india" MetaKeywords="best web design company in gwalior, bhind, murena, dabra, lahar, porsa, bammore, dholpur, agra, datia, jhansi, madhya pradesh, india" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="contact-us.aspx.cs" Inherits="ContactUs" enableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <p style="color:white;"> 15-D, Parsadi Pura behind of M.E.S. Power house Cantonment area, Near 6 &amp; 7 no. chauraha Morar-474006, Gwalior (M.P.) India<br><i>Phone:</i> <span class="phone_no">0751-2462230, 2466182</span> </p> 
	 ...
	 <%--  <h2 id="h2_5c14_1" class="vc_custom_heading ninzio-latter-spacing">Branch Office Surat </h2>
      ...
      <p style="color:white;">E-2109 Central Bazzar Oppo. Varachha Police station Surat(Gujrat)India <br><i>Phone:</i> <span class="phone_no">+91 9131722185, 79990719264</span></p> 
                                                    ...
                                                    <div  class="nz-column-text nz-clearfix  element-animate-false" data-effect="none" data-effect-speed="50" style="color:white;">its.gwl15@gmail.com, info@itsgwalior.com,  
                                                    ...
                                                    <div  class="nz-column-text nz-clearfix  element-animate-false" data-effect="none" data-effect-speed="50" style="color:white;">+91 89890-24130, 9131722185 
                                                        <br />
                                                    ...
                                                    <div  class="nz-column-text nz-clearfix  element-animate-false" data-effect="none" data-effect-speed="50" style="color:white;">+91 8770168831, 7512462230
